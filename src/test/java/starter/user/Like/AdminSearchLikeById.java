...
public class AdminSearchLikeById {

    private static String url = "http://34.128.69.15:8000/admin/news/like/search?id=NGVb3u";
    ...
    public void receiveValidData() {
        ...
        String schema = helper.getResponseSchema(JsonSchema.ADMIN_SEARCH_LIKE_BY_ID);
